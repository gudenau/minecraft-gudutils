...
public final class SwiftStrikeEnchantment extends Enchantment implements EnchantmentInfo{
    ...
    public Text getDescription(int level){
        return new TranslatableText("enchantment.gud_utils.swift_strike.info");
    }
}
